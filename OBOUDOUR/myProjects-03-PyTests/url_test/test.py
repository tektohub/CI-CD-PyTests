...
def exemple_html():
    ...
    #debug : erreur bytecode vs string :
    myPageHtml = '<!doctype html><html itemscope="" itemtype="http://schema.org/WebPage" laandard_p="image"><title>Google</title><script'
...
def test_extraire_title(exemple_html):
    assert extraire_title(exemple_html) == 'Google' # 'Apple' # 'Google'

""" def test_extraire_title(exemple_html):
    assert extraire_title(exemple_html) == 'Apple' """
